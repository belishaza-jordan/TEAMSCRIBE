...
<head>
  ...
  <title>Create account — TeamScribe Admin</title>
  <style>
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;background:var(--c-canvas);color:var(--c-fg);min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;font-size:14px;line-height:1.5}
    ...
    .note{font-size:11px;color:var(--c-fg2);margin-top:8px;line-height:1.5}
...
<div class="logo">
 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="40" height="40">
  ...
  <div class="logo-sub">Create your admin account</div>
</div>
<div class="card">
  <h1>Join TeamScribe</h1>
  @if ($errors->any())
  ...
  <form method="POST" action="{{ route('register') }}">
    ...
    <div class="field">
      ...
      <div class="pw-wrap" style="position:relative"><input id="password_confirmation" name="password_confirmation" type="password" required placeholder="Re-enter password" /><button type="button" class="pw-eye" onclick="togglePw(this)"><svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"><path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z"/><path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8Zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z"/></svg></button></div>
    </div>
    <p class="note">Admin access requires an existing admin to grant you the is_admin flag after registration.</p>
    <button type="submit" class="btn-submit" style="margin-top:14px">Create account</button>
  </form>
</div>
<div class="link-card">Already have an account? <a href="{{ route('login') }}">Sign in</a></div>
<script>
